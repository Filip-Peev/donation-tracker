...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            ...
            <a href="/donation-tracker/login.php" class="btn btn-outline-light btn-sm">Staff Login</a>
        </div>
    </nav>
            ...
            <div class="col-lg-6">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <a href="/donation-tracker/item.php?token=<?= e($item['qr_token']) ?>" class="btn btn-sm btn-outline-primary">
