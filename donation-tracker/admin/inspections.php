...
if (isset($_GET['delete']) && verify_csrf()) {
    ...
    redirect('/donation-tracker/admin/inspections.php');
}
    ...
    <div class="card-body">
        <form method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-md-4">
                ...
                <a href="/donation-tracker/admin/inspections.php" class="btn btn-outline-secondary">Clear</a>
            </div>
        </form>
    </div>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/donation-tracker/uploads/<?= e($row['photo_path']) ?>" target="_blank" class="btn btn-sm btn-outline-secondary">
