...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            ...
            <a href="/donation-tracker/admin/dashboard.php" class="btn btn-outline-light btn-sm">Back to Dashboard</a>
        </div>
    </nav>
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="/donation-tracker/admin/items.php?export=1" class="btn btn-sm btn-primary"><i class="bi bi-download"></i> Download JSON</a>
            </div>
        </div>
