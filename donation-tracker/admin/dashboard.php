...
$overdue = db()->query("
    ...
    HAVING last_inspected IS NULL OR last_inspected < DATE_SUB(NOW(), INTERVAL 3 MONTH)
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/donation-tracker/admin/items.php?edit=<?= $row['id'] ?>" class="btn btn-sm btn-outline-primary">View</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <a href="/donation-tracker/admin/items.php" class="btn btn-primary w-100 mb-2">
                    <i class="bi bi-plus-circle"></i> Add New Item
                </a>
                <a href="/donation-tracker/admin/locations.php" class="btn btn-outline-primary w-100 mb-2">
                    <i class="bi bi-geo-alt"></i> Manage Locations
                </a>
                <a href="/donation-tracker/admin/inspections.php" class="btn btn-outline-primary w-100 mb-2">
                    <i class="bi bi-clipboard-check"></i> View All Inspections
                </a>
                <a href="/donation-tracker/admin/items.php?export=1" class="btn btn-outline-secondary w-100">
