...
if (isset($_GET['delete']) && verify_csrf()) {
    ...
    redirect('/donation-tracker/admin/items.php');
}
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/donation-tracker/admin/items.php?export=1" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <?php if ($edit_item): ?>
                    <a href="/donation-tracker/admin/items.php" class="btn btn-outline-secondary w-100 mt-2">Cancel</a>
                    <?php endif; ?>
                </form>
            </div>
        </div>
                ...
                <table class="table table-hover table-sm mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="<?= ($item['status'] === 'lost') ? 'table-danger' : '' ?>">
                            <td><?= $item['id'] ?></td>
                            <td>
                                <a href="/donation-tracker/admin/items.php?edit=<?= $item['id'] ?>"><?= e($item['name']) ?></a>
                            </td>
                            ...
                            <td>
                                <a href="/donation-tracker/api/qr.php?token=<?= e($item['qr_token']) ?>" target="_blank" class="btn btn-sm btn-outline-secondary" title="View QR Code">
