...
if (!defined('DB_NAME')) define('DB_NAME', 'donation_tracker');
if (!defined('DB_USER')) define('DB_USER', 'root');
if (!defined('DB_PASS')) define('DB_PASS', '');
if (!defined('DB_CHARSET')) define('DB_CHARSET', 'utf8mb4');
if (!defined('APP_NAME')) define('APP_NAME', 'Donation Tracker');
if (!defined('APP_URL')) define('APP_URL', 'http://localhost/donation-tracker');
...
function require_login() {
    if (!is_logged_in()) {
        redirect('/donation-tracker/login.php');
    }
}
