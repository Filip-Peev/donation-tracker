...
if (!$token) {
    header('Location: /donation-tracker/check.php');
    exit;
}
...
<body>
    ...
    <div class="container py-5">
        <a href="/donation-tracker/check.php" class="btn btn-outline-secondary mb-4">
            ...
            <div class="col-lg-5">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <img src="/donation-tracker/api/qr.php?token=<?= e($item['qr_token']) ?>&size=200" alt="QR Code" class="img-fluid" style="max-width: 200px;">
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item <?= $color ?>">
                                ...
                                <?php if ($h['photo_path']): ?>
                                <div class="mt-2">
                                    <a href="/donation-tracker/uploads/<?= e($h['photo_path']) ?>" target="_blank">
                                        <img src="/donation-tracker/uploads/<?= e($h['photo_path']) ?>" class="img-thumbnail" style="max-height: 120px;">
                                    </a>
                                </div>
                                <?php endif; ?>
                                <?php if ($h['notes']): ?>
